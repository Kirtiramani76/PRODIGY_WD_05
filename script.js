...
let latitude=0;
let longitude=0;
let latitude1=26.765844;
let longitude2=83.364944;
let city="";
let value1="";
let value2="";
async function cll(){
...
{
  const store1=await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude1}&lon=${longitude2}&appid=${key}&units=metric`);
